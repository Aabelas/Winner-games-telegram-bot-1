...
async def on_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "deposit_tb":
        await edit_or_reply(
            ...
            InlineKeyboardMarkup([
                [InlineKeyboardButton("✔️ I've Paid", callback_data="paid_tb")],
    ...
    if data == "deposit_bank":
        await edit_or_reply(
            ...
            InlineKeyboardMarkup([
                [InlineKeyboardButton("✔️ I've Paid", callback_data="paid_bank")],
                [InlineKeyboardButton("⏹️ Back", callback_data="deposit")],
            ]),
        )
        return
    ...
    if data == "deposit_crypto":
        await edit_or_reply(
            ...
            "💎 *USDT (TRC20)*\nAddress: `TRxxx…xxxx`\n\nSend and then tap *I've Paid*.",
            InlineKeyboardMarkup([
                [InlineKeyboardButton("✔️ I've Paid", callback_data="paid_crypto")],
                [InlineKeyboardButton("⏹️ Back", callback_data="deposit")],
            ]),
        )
        return
    ...
    if data in {"paid_tb", "paid_bank", "paid_crypto"}:
        await edit_or_reply(
            update,
            "✔️ Thanks! Please send your payment receipt to support.\nOnce confirmed, coins will be added to your balance.",
            kb_back_main(),
        )
        return
